...
nsys profile -o cupy_simulation python simulate_cupy.py 20 # This will simulate 20 floorplans and take the average time it took to simulate using the time command
