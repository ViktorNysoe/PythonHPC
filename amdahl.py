...
def plot_and_save_speedup(workers, times, filename="speedup_plot.png"):
    baseline = times[0]
...
def save_speedup_csv(workers, times, speedups, filename="speedup_data.csv"):
...
def save_amdahl_analysis(parallel_fraction, max_speedup, achieved_speedup, num_cores, total_buildings, time_per_building, filename="amdahl_analysis.txt"):
    with open(filename, 'w') as f:
